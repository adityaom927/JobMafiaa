...
public class MyUserClassAdapter extends ArrayAdapter<User> implements FetchDataListener
{
    String path = null;
    ...
    LoginClass l;
    User u;
    public MyUserClassAdapter(Context context1, int resource, List<User> objects, LoginClass l1)
    {
    ...
    public View getView(final int position,View convertView, ViewGroup parent)
    {
        ...
        user_exp.setText(u.getTotal_exp());
